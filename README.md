...
> The code and materials in this repository are adapted from the paper "[How social learning amplifies moral outrage expression in online social networks](www.google.com) (2021).
...
To run the pre-trained model used in the article, you will need **required model files that are NOT hosted in this repository**. If you would like access to these files, please email Crocket Lab manager, [Caleb Kealoha](mailto:caleb.kealoha@yale.edu?subject=[GitHub]%20Outrage%20Classifier%20Access), for access. The omited files are:
